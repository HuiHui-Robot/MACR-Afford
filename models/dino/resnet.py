...
def ResNet50():
    return ResNet([3, 4, 6, 3], '../resource/resnet50-19c8e357.pth')

def ResNet101():
    return ResNet([3, 4, 23, 3], '../resource/resnet101-5d3b4d8f.pth')

def ResNet152():
    return ResNet([3, 8, 36, 3], '../resource/resnet152-b121ed2d.pth')